...
setup supabase with flutter project



## features
- display categorywise food item
- add to cart local
- order booking ui

## to be done
- user authencation
- integrating database and payment gateway
- upgrading setting of app
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/niranjandahal/Food_order_app.git
